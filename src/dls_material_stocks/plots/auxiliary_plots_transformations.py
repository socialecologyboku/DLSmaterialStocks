...
def plot_clustered_horizontal_bars(data, cols, title, base_keyword):
    ...
    rename_dict = {
    'currentB2DS': 'IEA B2DS transport modes',
    'currentEvs':'vehicles electric',
    'currenthhSizeHigh':'large households',
    'currenthhSizeLow':'small households',
    'currenthhSizeMedium':'median household size',
    'currentlightweight':'lightweight construction',
    'currentwoodBased':'wooden construction',
    'currentlightWood':'light & wooden construction',
    'currentlowCar':'low car use',
    'currentlowCarLowDemand':'low car use, low transp. demand',
    'currentlowMeat':'low meat',
    'currentRE':'renewable energy',
    'currentvegetarian':'vegetarian',
    'currentvegan':'vegan',
    'currentcombined':'combined: lightwood, low car,\n low transp., vegan, renewable, EVs',
    'convergedcombined': 'converged combined: \ncombined + median househ.size',
    #'convergedcombined':'combined: lightwood, low car,\n low transp., vegan, renewable, EVs',
    'convergedEvs':'vehicles electric',
    'convergedhhSizeHigh':'large households',
    'convergedhhSizeLow':'small households',
    'convergedlightweight':'lightweight construction',
    'convergedwoodBased':'wooden construction',
    'convergedlightWood':'light & wooden construction',
    'convergedlowCarLowDemand':'low car use, low transp. demand',
    'convergedlowCar':'low car use',
